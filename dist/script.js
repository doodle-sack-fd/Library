...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getElement = function (i) {
  const swap = this[i];
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getElementIndex = function () {
  const parent = this[0].parentNode;
  /*Изначально html коллекция, 
  а затем мы все элементы разворачиваем в виде массива
   */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
